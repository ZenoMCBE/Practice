...
final class TopDeathFloatingTextEntity extends Monster {
    ...
    public function onUpdate(int $currentTick): bool {
        $position = 1;
        $leaderboard = array_slice($this->getStatisticsHandler()->getTop(Statistic::DEATH), 0, 10);
        $content = "§l§qTOP DEATH";
